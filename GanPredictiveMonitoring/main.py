...
if __name__ == "__main__":
    # execute only if run as a script
        ...
        run("dataset/dataset/helpdesk.csv","event_timestamp_prediction", prefix=2, epoch=25) 
        run("dataset/dataset/helpdesk.csv","event_timestamp_prediction", prefix=4, epoch=25) 
        run("dataset/dataset/helpdesk.csv","event_timestamp_prediction", prefix=6, epoch=25) 

        run("dataset/dataset/bpi_12_w.csv","event_timestamp_prediction", prefix=2, epoch=25)
        run("dataset/dataset/bpi_12_w.csv","event_timestamp_prediction", prefix=4, epoch=25)
        run("dataset/dataset/bpi_12_w.csv","event_timestamp_prediction", prefix=6, epoch=25)
        run("dataset/dataset/bpi_12_w.csv","event_timestamp_prediction", prefix=16, epoch=25)
        run("dataset/dataset/bpi_12_w.csv","event_timestamp_prediction", prefix=30, epoch=25)
